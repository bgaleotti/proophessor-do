...
use Prooph\ProophessorDo\Container\App\Action\UserTodoListFactory;
use Prooph\ServiceBus\QueryBus;
use Psr\Container\ContainerInterface;
use Zend\Expressive\Template\TemplateRendererInterface;

final class UserTodoListFactoryTest extends TestCase
{
    /**
     * @test
     */
    public function it_creates_new_user_todo_list_action(): void
    {
        ...
        $factory = new UserTodoListFactory();
        $userTodoListAction = $factory($container->reveal());

        self::assertInstanceOf(UserTodoList::class, $userTodoListAction);
    }
}
